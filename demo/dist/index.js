...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib__ = __webpack_require__(44);
...
new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
    ...
    data: {
        test: 'test',
        RemoteConsole: __WEBPACK_IMPORTED_MODULE_1__lib__["a" /* default */]
    },
    created: function created() {
        window.axios.get('./index.html').then(function (response) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__console__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__network__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__storage__ = __webpack_require__(88);

var rConsole = new __WEBPACK_IMPORTED_MODULE_0__console__["a" /* default */]();
window.$rc = rConsole;


var rNetwork = new __WEBPACK_IMPORTED_MODULE_1__network__["a" /* default */]();
window.$rn = rNetwork;


var rStorage = new __WEBPACK_IMPORTED_MODULE_2__storage__["a" /* default */]();
window.$rs = rStorage;
...
window.__REMOTE_CONSOLE = __REMOTE_CONSOLE;

/* harmony default export */ __webpack_exports__["a"] = (__REMOTE_CONSOLE);
...
var Console = function () {
    function Console() {
        __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, Console);
    ...
    __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Console, [{
        key: 'mockConsole',
        value: function mockConsole() {
            ...
            if (!window.console) {
                ...
                methodList.map(function (method) {
                    _this.console[method] = window.console[method];
                });
            ...
            window.console.clear = function () {
                ...
                _this.logList = [];
                _this.console.clear.apply(window.console, args);
            };
        }
    }, {
        key: 'printLog',
        value: function printLog(opt) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__tool__ = __webpack_require__(73);
...
var Network = function () {
    function Network() {
        __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck___default()(this, Network);
    ...
    __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(Network, [{
        key: 'mockAjax',
        value: function mockAjax() {
            ...
            window.XMLHttpRequest.prototype.open = function () {
                ...
                var onreadystatechange = function onreadystatechange() {
                    ...
                    return _onreadystatechange.apply(XMLReq, _arguments);
                };
            ...
            window.XMLHttpRequest.prototype.send = function () {
                ...
                var item = that.reqList[XMLReq._ajaxRequestID] || {};
                item.method = XMLReq._method.toUpperCase();

                var query = XMLReq._url.split('?');
                ...
                if (query.length > 0) {
                    ...
                    try {
                        for (var _iterator = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator___default()(query), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            var q = _step.value;
                ...
                if (item.method == 'POST') {
                    ...
                    if (__WEBPACK_IMPORTED_MODULE_4__tool__["b" /* isString */](data)) {
                        var arr = data.split('&');
                        item.postData = {};
                        ...
                        try {
                            for (var _iterator2 = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator___default()(arr), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                                var _q = _step2.value;
                    ...
                    } else if (__WEBPACK_IMPORTED_MODULE_4__tool__["a" /* isPlainObject */](data)) {
                        item.postData = data;
                    }
                }
        ...
        value: function updateRequest(id, data) {
            ...
            this.reqListLength = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default()(this.reqList).length;
        }
    }, {
        key: 'getUniqueID',
...
function isObject(value) {
    return Object.prototype.toString.call(value) == '[object Object]' || !isNumber(value) && !isString(value) && !isBoolean(value) && !isArray(value) && !isNull(value) && !isFunction(value) && !isUndefined(value) && !isSymbol(value);
}
function isFunction(value) {
    return Object.prototype.toString.call(value) == '[object Function]';
}
function isElement(value) {
    return (typeof HTMLElement === 'undefined' ? 'undefined' : __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default()(HTMLElement)) === 'object' ? value instanceof HTMLElement : value && (typeof value === 'undefined' ? 'undefined' : __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default()(value)) === 'object' && value !== null && value.nodeType === 1 && typeof value.nodeName === 'string';
}
...
function isPlainObject(obj) {
    ...
    if (!obj || (typeof obj === 'undefined' ? 'undefined' : __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default()(obj)) !== 'object' || obj.nodeType || isWindow(obj)) {
        return false;
    }
    try {
